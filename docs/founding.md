# Sykli — Founding Document

Founded 2026-08-05 (drafted 2026-08-04 in the predecessor repository). This
document founds this sykli — a clean-break rewrite. The Elixir predecessor,
[false-systems/sykli-elixir](https://github.com/false-systems/sykli-elixir),
is the reference implementation; its test suite is the executable
specification. Decisions here are recorded as ADRs in `adr/`.
