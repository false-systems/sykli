...
The first published release. Version 0.2.0 was bumped in the crate and
described below but never tagged or published; everything listed under it
first ships here, together with the additions below.
...
Bumped in `Cargo.toml` but never tagged or published; first shipped in 0.3.0.
...
[Unreleased]: https://github.com/false-systems/sykli/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/false-systems/sykli/releases/tag/v0.3.0
